import { X, Check, XCircle, User, Calendar, Building2, FileText, Link as LinkIcon, Tag } from 'lucide-react';
      ...
      <div className="modal-content view-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="request-details-section">
            <h3>{request.type === 'achievement' ? 'Achievement' : request.type === 'certificate' ? 'Certificate' : 'Project'} Information</h3>
